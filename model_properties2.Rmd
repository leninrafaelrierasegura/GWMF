...
```{r}
# Choose a row number, any between 1 and dim(est_cov_matrixi)[1]
rownumber <- 289 
# Choose alpha
nu1 <- 0.4
alpha1 <- nu1 + 1/2
  ...
  layout(font = list(family = "Palatino"),
      ...
      center = list(x = 0, y = 0, z = 0)),     # Focus point
           annotations = list(
             ...
             list(
               x = 3, y = 4, z = 0.35,
               text = TeX(paste0("\\bullet\\mbox{ ", nu1, "}")),
               textangle = 0, ax = 60, ay = 0,
               font = list(color = "blue", size = 16),
               arrowcolor = "white", arrowsize = 1, arrowwidth = 0.1,arrowhead = 1),
             list(
               x = 3, y = 4, z = 0.33,
               text = TeX(paste0("\\bullet\\mbox{ ", nu2, "}")),
               textangle = 0, ax = 60, ay = 0,
               font = list(color = "red", size = 16),
               arrowcolor = "white", arrowsize = 1, arrowwidth = 0.1,arrowhead = 1),
             list(
               x = 3, y = 4, z = 0.31,
               text = TeX(paste0("\\bullet\\mbox{ ", nu3, "}")),
               textangle = 0, ax = 60, ay = 0,
