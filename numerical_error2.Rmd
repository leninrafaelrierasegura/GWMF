...
p <- ggplot(dat, aes(nu, error, colour = as.factor(m))) + 
  ...
  labs(x = bquote(nu ~ "(smoothness parameter)"), y = "Covariance Error", color = "m") + ggtitle("Interval graph")
```


```{r, fig.dim = c(12,6), class.source = "fold-hide"}
p
ggsave(here("data_files/new_interval_upto1.5.png"), plot = p, dpi = 300)
```
...
p <- ggplot(dat, aes(nu, error, colour = as.factor(m))) + 
  ...
  theme(panel.spacing = unit(0.3, "cm"), text = element_text(family = "Palatino"),
        ...
        legend.title = element_text(size = 14),      # Legend title
        legend.text = element_text(size = 12)) +
  labs(x = bquote(nu ~ "(smoothness parameter)"), y = "Covariance Error", color = "m") + ggtitle("Circle graph")
```

```{r, fig.dim = c(12,6), class.source = "fold-hide"}
p
ggsave(here("data_files/new_circle_upto1.5.png"), plot = p, dpi = 300)
```
...
p <- ggplot(dat, aes(nu, error, colour = as.factor(m))) + 
  ...
  theme(panel.spacing = unit(0.3, "cm"), text = element_text(family = "Palatino"),
        ...
        legend.title = element_text(size = 14),      # Legend title
        legend.text = element_text(size = 12)) +
  labs(x = bquote(nu ~ "(smoothness parameter)"), y = "Covariance Error", color = "m") + ggtitle("Tadpole graph")
```

```{r, fig.dim = c(12,6), class.source = "fold-hide"}
p
ggsave(here("data_files/new_tadpole_upto1.5.png"), plot = p, dpi = 300)
```
