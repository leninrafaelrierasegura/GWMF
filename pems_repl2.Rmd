...
data_prd_list_for_rep[["repl"]] <- rep(replicate.number, nrow(data_prd_list_mesh$loc))
# Perform the prediction
repl1_pred_full <- predict(rspde_model_nonstat, cmp_nonstat, rspde_fit_nonstat, newdata = data_prd_list_for_rep, ~Intercept + mean_value + field_eval(loc, replicate = repl))
repl1_pred_mean <- repl1_pred_full$pred$mean
...
label_mapping <- c(
  ...
  "Statnu1.5" = "1.5", 
  "Nonstatnu1.5" = "1.5", 
  "Statnuest" = paste(round(mean_and_mode_params_statnuest[5,1], 3), "(est)"), 
  "Nonstatnuest" = paste(round(mean_and_mode_params_nonstatnuest[7,1], 3), "(est)")
)
