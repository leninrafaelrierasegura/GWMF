...
Among other things, the value of some covariates on the observation and mesh locations were computed. Groups for the leave-group-out pseudo cross-validation were also created.

For the $\texttt{R}$ code performing this step follow this [link](preprocessing/pp6.html).